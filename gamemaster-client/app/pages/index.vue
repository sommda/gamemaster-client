...
const { recordInteraction, fetchCurrentTranscript, fetchTranscriptAsMessages, fetchCurrentGameState, getClient } = useMcpClient()
...
onMounted(async () => {
  ...
  // Load existing transcript and game state on page load
...
<template>
  <div class="layout">
    ...
    <aside class="right">
      ...
      <div v-if="gameState.in_combat" class="combat-section">
